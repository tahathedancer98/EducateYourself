            ...
            <div class="col-md-6">
                <div class="row">
                    ...
                    @if(\Illuminate\Support\Facades\Auth::check() && \Illuminate\Support\Facades\Auth::User()->is_admin != null)
                        <div class="col-md-12">
                            <p>Administation des Formations + Catégories + Chapitres</p>
                        </div>
                    @elseif(\Illuminate\Support\Facades\Auth::check() && \Illuminate\Support\Facades\Auth::User()->is_admin == null)
                        <div class="col-md-12">
                            <p>Administation de vos Formations</p>
                        </div>
                    @else
                        <div class="col-md-12">
