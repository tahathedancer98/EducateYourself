...
<footer class="bg-dark text-center text-white" style="margin-top: 3em;">
    ...
    <div class="container p-4">
        ...
        <section class="mb-4">
            <!-- Instagram -->
            <a class="btn btn-outline-light btn-floating m-1" href="https://www.instagram.com/lilhunter98"
               target="_blank"
               role="button"
            ...
            <div class="row">
                ...
                <div class="col-12" style="float: left;">
                    <ul class="list-unstyled mb-0">
                        <a href="#" class="btn btn-dark">PHP</a>
                        <a href="#" class="btn btn-dark">LARAVEL</a>
                        <a href="#" class="btn btn-dark">MYSQL</a>
                        <a href="#" class="btn btn-dark">BOOTSTRAP</a>
                    </ul>
                </div>
                <!--Grid column-->
    ...
    <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2);">
        © 2021 Copyright:
        <a class="text-white" href="https://github.com/tahathedancer98/ProjetLaravelM1/tree/master">Taha TOUFIK</a>
    </div>
    <!-- Copyright -->
</footer>
<!-- Footer -->
